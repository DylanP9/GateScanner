...
import AirportDetailReportPanel from "@/components/AirportDetailReportPanel";
  ...
  return (
    <main className="min-h-screen bg-slate-50 text-slate-950">
      <div className="bg-[#05203c]">
        ...
        <section className="mx-auto max-w-7xl px-4 pb-12 pt-8 text-white sm:px-6 md:pb-14 md:pt-10">
          <Link
            href="/"
          ...
          <div className="mt-8 flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
            <div>
              ...
              <p className="mt-4 text-base font-semibold text-sky-50/80 sm:text-lg">
      ...
      <section className="mx-auto max-w-7xl px-4 py-10 sm:px-6">
        ...
        <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="space-y-8">
              ...
              <div className="flex flex-col justify-between gap-4 md:flex-row md:items-start">
                <div>
                  ...
                  <p className="mt-3 max-w-2xl text-sm font-semibold leading-7 text-slate-500">
                    ...
                    passport control, baggage, and customs. This page will
                    later connect to live Supabase data.
                  </p>
                </div>
            ...
            <AirportDetailReportPanel airport={airport} />
          </div>
